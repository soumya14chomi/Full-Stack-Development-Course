package JDBCExamples.controller;

import java.sql.SQLException;
import java.util.List;

import JDBCExamples.model.Employee;
import JDBCExamples.service.EmployeeService;
import JDBCExamplesRepository.DbRepository;
...
public class EmployeeController {
	...
	public void addData() throws SQLException {
		...
		Boolean status = es.save(new Employee(105, "Soumya", "sodj@gmail.com", 23893f));
	...
	public void update() throws SQLException {
		...
		Employee employee = new Employee(104, "Soumya", "sjdh@gmail.com", 2398f);
